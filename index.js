...
// If you click Ok or Cancel
else {
  alert(
    "Canceling the game of Rock, Paper, Scissors? Or Did you forget to type a command? Must be trying to dodge a paper cut or a rock slide! 🪨📄✂️"
  );
}
